...
- **기존 플랫폼의 복잡한 인터페이스**: 문제 (단체 카톡방, 구글 폼 etc.)와 코드 입력 창(vscode etc.)이 분리되어 있어 학습 몰입을 방해했어요.
...
- 운영자/멘토가 직접 문제를 등록할 수 있는 **문제 제작 페이지** 를 제공해요.
- 문제에는 다음과 같은 요소를 포함할 수 있어요:
    ...
    - 테스트 케이스
    - 출처 및 카테고리
- 이를 통해 운영자는 스터디 시간에 문제를 카톡 방에 올리거나 구글 폼으로 스터디 부원들이 푼 문제를 확인하는 불편함을 줄일 수 있었어요. 
