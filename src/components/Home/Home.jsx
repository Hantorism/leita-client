    ...
    return (
        <div className="flex flex-col items-start h-screen text-white pl-[10%] pr-[10%] pt-[5%]">
            ...
            <div className="flex flex-col items-start justify-center w-[80%] max-w-[600px] p-5 pl-[6%] pt-[8%]">
                <div
                    className="inline-flex items-center gap-1 bg-white bg-opacity-10 px-3 py-2 rounded-[60px] w-fit mb-5">
                ...
                {/*<img src="/image/gradient.png" alt="Floating Gradient" className="floating-image"/>*/}
            </div>
            {/* <Footer /> */}
        </div>
    );
