...
const TermPage = () => {
  return (
    <div className="flex flex-col items-start h-full bg-[var(--color-bg-main)] font-Pretendard pt-8 text-white">
      ...
      <div className="max-w-3xl mx-auto p-6 pb-20">
        ...
        <p>
          이 약관은 [leita] (이하 "leita")이 구글 OAuth 인증을 통해 제공하는 서비스 이용에 관한 조건을 정함을 목적으로
          합니다.
        </p>
        ...
        <p>
          1. 서비스는 구글 OAuth 인증을 통해 사용자의 구글 계정 정보에 접근하며, 이는 사용자 인증 및 서비스 제공에만
          사용됩니다.
        </p>
        ...
        <p>
          3. 서비스는 이용자의 개인정보를 보호하기 위해 합리적인 보안 조치를 취하고 있으며, 개인정보는 관련 법령에 따라
          안전하게 처리됩니다.
        </p>

        <h3 className="text-lg font-semibold mt-4">제 4조 (서비스 이용)</h3>
        <p>
          1. 사용자는 구글 OAuth 인증을 통해 자신의 구글 계정 정보를 서비스에 제공함으로써, 서비스에 로그인하고 다양한
          기능을 이용할 수 있습니다.
        </p>
        <p>
          2. 서비스는 이용자가 제공한 정보를 기반으로 기능을 제공합니다. 사용자가 제공하는 정보는 정확해야 하며, 이를
          통해 발생하는 문제는 사용자가 책임집니다.
        </p>
        ...
        <p>
          1. 사용자는 서비스를 이용함에 있어 구글 OAuth 인증을 통해 제공한 정보를 정확하게 입력해야 하며, 이를 타인에게
          양도하거나 공유할 수 없습니다.
        </p>
        ...
        <p>
          2. 개인정보는 서비스 제공과 관련된 목적 외에는 사용되지 않으며, 이용자의 동의 없이 제3자에게 제공되지
          않습니다.
        </p>

        <h3 className="text-lg font-semibold mt-4">제 8조 (면책조항)</h3>
        <p>
          1. 서비스는 사용자가 제공한 정보의 정확성에 대해 보증하지 않으며, 사용자로 인해 발생하는 문제에 대해서는
          책임을 지지 않습니다.
        </p>
        ...
        <p>
          1. 서비스는 본 약관을 언제든지 변경할 수 있습니다. 변경된 약관은 서비스 내에 게시된 날로부터 효력을
          발생합니다.
        </p>
