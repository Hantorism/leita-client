  ...
  return (
    <div className="flex flex-col items-start h-full bg-[var(--color-bg-main)] font-Pretendard pt-8 text-white">
      ...
      <div className="max-w-3xl mx-auto p-6 pb-20">
        ...
        <p>
          [leita] (이하 "leita")는 사용자의 개인정보를 중요하게 생각하며, 개인정보 보호법 및 관련 법령을 준수합니다. 본
          개인정보 처리방침은 서비스 이용 시 수집되는 개인정보, 이용 목적, 보관 및 보호 방법 등에 대해 설명합니다.
        </p>
        ...
        <p>
          서비스는 원칙적으로 사용자의 개인정보를 외부에 제공하지 않습니다. 다만, 다음의 경우에는 예외적으로 제공될 수
          있습니다.
        </p>
        <ul className="list-disc pl-5">
        ...
        <p>
          본 개인정보 처리방침은 법령 변경 및 서비스 운영 정책에 따라 개정될 수 있습니다. 변경 사항은 서비스 내
          공지사항을 통해 안내됩니다.
        </p>
        ...
        <p>
          <strong>이메일:</strong> leitaajou@gmail.com
        </p>
      </div>
