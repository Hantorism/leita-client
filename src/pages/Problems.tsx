              ...
              {filteredProblems.length > 0 ? (
                filteredProblems.map((problem, index) => (
                  <tr
                    ...
                    className={`cursor-pointer border-b border-gray-500 hover:bg-black hover:text-[#CAFE33] transition ${
          ...
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              ...
              className={`px-3 py-1 mx-1 rounded-full transition ${
                currentPage === i ? 'bg-[#CAFE33] text-black' : 'bg-gray-700 text-white hover:bg-gray-600'
              }`}
            >
              {i + 1}
            </button>
