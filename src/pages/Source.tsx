      ...
      <main className="flex-1 container mx-auto px-6 py-12 max-w-4xl">
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl font-bold text-[var(--color-brand)]">제출 소스 코드</h1>
        ...
        <div className="bg-[var(--color-bg-card)] rounded-xl border border-gray-700/50 shadow-xl overflow-hidden p-6 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 border-b border-gray-800 pb-4 gap-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-gray-500 text-sm">|</span>
              <span className="text-gray-300 text-sm">시간: {formatTime(0)}</span>
            </div>
            <button
              onClick={() => {
              ...
              className="bg-[#2a2a2a] hover:bg-[#3a3a3a] text-gray-300 px-3 py-1.5 rounded-md text-sm transition-colors border border-gray-700"
            >
              복사하기
            </button>
          </div>
