import type { CreateProblemRequest, CreateProblemResponse, DeleteProblemResponse, PopularPeriod, ProblemDetail } from '@leita/types';
import { AxiosInstance, type PagedResponse } from '../utils/AxiosInstance';
